...
class RoundEdgedButton extends StatelessWidget {
  ...
  final bool isSingleLeftContent;
  ...
  const RoundEdgedButton(
      {
        ...
        this.isSolid=true,
        this.isSingleLeftContent=false,
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Row(
          ...
          mainAxisAlignment: !isSingleLeftContent ? MainAxisAlignment.spaceAround : MainAxisAlignment.start,
          children: [
            Text(
              text,
              textAlign: textalign,
